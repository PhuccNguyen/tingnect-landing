...
export const metadata: Metadata = {
  ...
  description: 'Official TingNect platform - Premier Web3 community connecting founders, builders, and innovators. Join exclusive events, networking sessions, and shape the future of decentralized technology in Vietnam and globally.',
  keywords: [
    'TingNect',
    'Web3 Vietnam',
  ...
  icons: {
    icon: [
      { url: '/Image/Logo/TingNect/TingNect-icon.svg', type: 'image/svg+xml' },
  ...
  openGraph: {
    ...
    description: 'Join TingNect official platform - Premier Web3 community in Vietnam. Connect with founders, builders, and innovators shaping the decentralized future.',
    images: [
      {
        url: '/Image/Logo/TingNect/TingNect-icon.svg',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description: 'Premier Web3 community connecting founders and builders. Join exclusive events in Vietnam.',
...
const structuredData = {
  ...
  '@type': 'Organization',
  name: 'TingNect',
  description: 'Official Web3 community platform connecting founders, builders, and innovators',
  url: 'https://tingnect.com',
  logo: 'https://tingnect.com/Image/Logo/TingNect/TingNect-icon.svg',
  foundingDate: '2024',
  founders: [
    {
      '@type': 'Person',
      name: 'TingNect Founders'
    }
  ],
  contactPoint: {
    '@type': 'ContactPoint',
